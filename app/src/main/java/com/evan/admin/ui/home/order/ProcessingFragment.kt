...
class ProcessingFragment : Fragment(), KodeinAware, IOrderUpdateListener {

    override val kodein by kodein()

    private val factory: ProcessingOrderModelFactory by instance()
    ...
    override fun onCreateView(
        ...
        viewModel = ViewModelProviders.of(this, factory).get(ProcessingOrderViewModel::class.java)
