...
class ProcessingOrderViewModel (
    val repository: HomeRepository,
    val alertListSourceFactory: ProcessingOrderSourceFactory
) : ViewModel() {
    ...
    fun getNetworkState(): LiveData<NetworkState> =
        Transformations.switchMap<ProcessingDataSource, NetworkState>(
            alertListSourceFactory.mutableLiveData,
            ProcessingDataSource::networkState
        )
