...
import kotlinx.android.synthetic.main.layout_post_list.view.*
import java.text.SimpleDateFormat
import java.util.*
import java.util.concurrent.TimeUnit

class PostAdapter (val context: Context, val updateListener: IPostUpdateListener) :
...
class AlertViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    fun bind(context: Context, post: Post?, position: Int, listener: IPostUpdateListener) {
